...
Each card opens its repository, except road accident severity, which opens its live demo ([repository](https://github.com/Chirudeva-Reddy/Road-Accident-Severity-Prediction)). Other live demos: [ClaimLens](https://chirudeva-reddy.github.io/ClaimLens/) and [hallucination detection](https://chirudeva-reddy.github.io/NLP-Proj/).
