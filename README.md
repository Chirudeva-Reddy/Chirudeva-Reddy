...
I lift most days, so the same workflow that renders everything else plots it. Sessions live in [data/training.csv](data/training.csv); the sparkline is weekly minutes over the last 26 weeks.
...
<picture>
  ...
  <img width="100%" src="https://raw.githubusercontent.com/Chirudeva-Reddy/Chirudeva-Reddy/output/training.svg" alt="Weekly training minutes over the last 26 weeks" />
</picture>
